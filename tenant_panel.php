    ...
    <section class="container-fluid my-5 w-100 m-auto d-flex align-items-center text-center">
        ...
        <div class="container text-center">
            ...
            <div>
                ...
                // Get the property ID manually (73 in this case)
                $propertyId = 73;
                $agent_id = "";
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if (!isset($_POST['rating'])) {
                            ...
                            $query = "SELECT * FROM tenant_ratings 
                                        WHERE user_id='{$_SESSION['user_id']}' AND property_id='$propertyId'";
                            $result = mysqli_query($conn, $query);
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                VALUES ('$propertyId', '$rating', '{$_SESSION['user_id']}')";
                                $result = mysqli_query($conn, $query);
